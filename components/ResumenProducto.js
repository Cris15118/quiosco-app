...
function ResumenProducto({ producto }) {
  ...
  return (
    <div className=" shadow-md border p-5 mb-3 flex gap-10 items-center">
      ...
      <div>
        <button
          type="button"
          className="bg-sky-700 flex gap-2 px-7 py-2 text-white rounded-md font-bold uppercase shadow-md w-full mb-3  "
